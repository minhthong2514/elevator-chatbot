...
class ElevatorAI:
    def __init__(self):
        ...
        # 1. Khởi tạo Model từ biến môi trường
        ...
        # 2. Cấu hình MongoDB từ biến môi trường
        ...
        self.uri = f"mongodb+srv://{user}:{safe_pass}@{cluster}/?retryWrites=true&w=majority"
        
        self.client = MongoClient(self.uri)
        self.db = self.client[db_name]
        self.collection = self.db[collection_name]
        
        print(f"Kết nối thành công Database: {db_name}")
